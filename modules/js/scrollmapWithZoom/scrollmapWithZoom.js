 ...
 * Coded by yannsnow
 * */
var ScrollmapWithZoomNS;
(function(ScrollmapWithZoomNS) {
    class AppStorage {
    ...
    class Logger {
        constructor() {
            ...
            this._enPersistentLoaded = false;
            this._enViaHash = (window.location.hash.substring(1).split(',').includes('debugSWZ'));
            this._en = this._enViaHash;
        }
        set enPersistent(en) {
    ...
    class ScrollmapWithZoom {
        static get debugEnPersistent() {
            return debugSWZ.enPersistent;
        };
        static set debugEnPersistent(en) {
    ...
    ScrollmapWithZoomNS.ScrollmapWithZoom = ScrollmapWithZoom;
    ...
    })(ScrollmapWithZoom = ScrollmapWithZoomNS.ScrollmapWithZoom || (ScrollmapWithZoomNS.ScrollmapWithZoom = {}));
    // if (window.location.hash.substring(1).split(',').includes('debugSWZ'))
    //     ScrollmapWithZoom.debugEn = true;
    var SWZ = ScrollmapWithZoom;
})(ScrollmapWithZoomNS || (ScrollmapWithZoomNS = {}));
